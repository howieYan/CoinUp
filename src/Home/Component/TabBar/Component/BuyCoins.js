...
export default class BuyCoins extends Component {
    ...
    constructor(props){
        super(props);
        this.state ={
            dataSource:this._dataSource.cloneWithRows(api.apiBuyCoins),
            List: [],
            total:'',
            classify: 1,
            size: 10,
                    ...
                    <View style={styles.ListViewItems}>
                        <View style={styles.ListViewHeader}>
                            <View style={[styles.content,{flexDirection: 'row',alignItems: 'center'}]}>
                                <Image style={styles.ListItemsAvatar} source={rowData.avatar ? {uri: rowData.avatar} : require('../../../../Image/My/UserActiver.png')}/>
    ...
    // 详情
    onDetails (record) {
        this.props.navigation.navigate('Details', {name: '购买', id: record.sell_id, status: 2})
    }
}
