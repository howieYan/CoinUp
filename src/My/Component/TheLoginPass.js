...
export default class TheLoginPass extends Component {
        ...
        return (
            <View style={styles.content}>
                <View style={styles.inputList}>
                   ...
                   <Text style={styles.inputBottomText}> 登录密码至少6位，可以是字母、数字及其他符号的组合。</Text>
    ...
    async LoadData () {
        try {
            ...
            let data = await Utils.LoadPost(Utils.size.url + '/api/my/setPwd', formData)
            console.log(data)
